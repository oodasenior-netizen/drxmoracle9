      ...
      <div className="mx-auto max-w-4xl space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Connected as {guestName}</p>
          </div>
        ...
        <Card className="h-[calc(100vh-12rem)]">
          ...
          <CardContent className="flex flex-col h-[calc(100%-5rem)] p-4 space-y-4">
                  ...
                  <div key={msg.id} className={`flex ${msg.sender_type === "guest" ? "justify-end" : "justify-start"}`}>
                    <div
                      className={`max-w-[70%] rounded-lg px-4 py-2 ${
                        msg.sender_type === "guest" ? "bg-primary text-primary-foreground" : "bg-muted"
                      }`}
                    >
